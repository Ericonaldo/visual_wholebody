        ...
        if ("name" in argument) and ("type" in argument or "action" in argument):
            ...
            if "type" in argument:
                if "default" in argument:
                    parser.add_argument(argument["name"], type=argument["type"], default=argument["default"], help=help_str, required=required)
                else:
                    parser.add_argument(argument["name"], type=argument["type"], help=help_str, required=required)
            elif "action" in argument:
                parser.add_argument(argument["name"], action=argument["action"], help=help_str, required=required)
