...
asset_descriptors = [
    ...
    AssetDesc("urdf/interbotix_xsarm_descriptions/urdf/wx250.urdf", False),
    AssetDesc("urdf/a1_description/urdf/a1.urdf", True),
    AssetDesc("urdf/go1_description/urdf/go1.urdf", True),
    AssetDesc("urdf/widowGo1/urdf/widowGo1.urdf", False)
]
